...
- [Floating window with custom content](/recipes/floating-window).
- [Modal dialog with async result](/recipes/dialog-modal).
- [Right-click menu](/recipes/right-click-menu).
- [Toast notifications](/recipes/notifications).
