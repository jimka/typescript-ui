...
> **Base class.** [`AbstractWindow`](/api/core/classes/AbstractWindow) is the abstract base shared by [`Window`](/components/Window) and [`TabWindow`](/components/TabWindow). It is **not** directly instantiable — construct one of its concrete subclasses instead.
...
- [API: AbstractWindow](/api/core/classes/AbstractWindow)
