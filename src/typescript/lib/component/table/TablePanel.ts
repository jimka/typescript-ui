...
class TablePanel extends Panel {
    ...
    constructor(store: AbstractStore) {
        ...
        addBtn.on("click", () => this._table.addRow());
        ...
        removeBtn.on("click", () => this._table.removeSelectedRow());
        ...
        this._syncBtn.on("click", () => this._table.sync());
        ...
        this._rejectBtn.on("click", () => this._table.reject());
