...
export type { TabOptions, TabEvent, TabWidthMode, TabSide, TabAlign, TabOrientation, TabDetachWindowMode } from '~/layout/Tab.js';
...
export type { AxisPosition, AxisSpread } from '~/layout/AxisAlign.js';
