...
import { Grid, GridConstraints } from '@jimka/typescript-ui/layout';
import { Button } from '@jimka/typescript-ui/component/button';

/**
 * Demo panel exercising the {@link Grid} layout's flexible track sizing, cell
 * spanning, explicit placement, and clip-on-overflow behaviour.
 *
 ...
 * the top-right cell, and one oversized child is clipped to the narrow fixed
 * column. The remaining buttons auto-flow around the reserved cells. A
 * commented-out overlapping pair can be enabled to trip the collision warning.
 */
