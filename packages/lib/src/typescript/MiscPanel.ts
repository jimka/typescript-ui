...
class MiscPanel extends Panel {
    ...
    constructor() {
        ...
        Event.addListener(buttonContextMenu, "contextmenu", { button: "any", handler: (e: MouseEvent): Event.ListenerResult => {
            Tooltip.hide();
        ...
        Event.addListener(buttonTallContextMenu, "contextmenu", { button: "any", handler: (e: MouseEvent): Event.ListenerResult => {
            Tooltip.hide();
