...
export type { DOMSink, DOMSource, DOMSeams, DocumentSelectionRange, TextSelectionRange, Rect, ScrollMetrics, OffsetSize, MediaState, ComputedFont, TextAdvanceSpacing, Handle, TimerId, ElementPatch, MediaQueryResult } from '~/core/DOM.js';
