...
export const conventions = [
    ...
    { rule: "Mount with `const body = await Body.init({ layoutManager })`, then `body.addComponent(root)`; use `Body.getInstance()` only to reach the body afterwards.", doc: "docs/components/Body.md" },
