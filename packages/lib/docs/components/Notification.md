...
- **The stack follows the viewport** — resizing the window re-stacks every live toast into the new bottom-right corner, with no show or dismissal needed to move them.
