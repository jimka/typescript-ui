 ...
 *
 * 320 is the toolbar and the five body rows with room to click Add/Remove
 * without the frame feeling cramped.
 */
export const height: number = 320;

/**
 * A `TablePanel` over the PEOPLE store, showing its built-in add / remove /
 * sync toolbar.
 *
