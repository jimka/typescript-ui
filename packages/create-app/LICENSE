...
software according to _Distribution License_ and make changes or new works
based on the software according to _Changes and New Works License_.
...
changes and new works permitted by _Changes and New Works License_.
...
> Required Notice: Copyright Jimmy Karlsson
...
Any purpose is a permitted purpose except for _Commercial Purposes_.

## Commercial Purposes

_Commercial Purposes_ means any purpose related to running a business, selling
goods or services, or providing services to others for compensation.
_Commercial Purposes_ includes, but is not limited to:

1. providing access to the software or its functionality as a web service
2. using the software or its functionality to produce or provide goods or
   services for compensation
3. using the software or its functionality to run business operations
4. using the software or its functionality for research and development that
   could result in commercial products or services

## Noncommercial Educational Use

Use of the software for noncommercial educational purposes is a
_Permitted Purpose_.
...
terms, and you take all reasonable steps to correct the violation within 32
days after your notification, you may keep your license for the software. If
you do not cure the violation in that time, your licenses end immediately and
permanently. If you use the software in violation of these terms, such use is
not licensed.
